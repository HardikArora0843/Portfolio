...
const projects = [
  ...
  },
  {
    ...
    description: "A RESTful Web Service built with Node.js, Express, and MongoDB to manage people.The service supports basic CRUD operations with well-structured endpoints and schema validation.",
    image: "/projects/PeopleManager.png?height=400&width=600",
    tags: ["MongoDB","Express","NodeJs","ReactJs","JavaScript","ES6","Postman"],
    github: "https://github.com/HardikArora0843/Person-Manager/",
    demo: "https://person-manager-fxoz.onrender.com/",
    featured: false,
  },
  {
    title: "Vision Chat",
